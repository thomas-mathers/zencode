...
{
    protected IReadOnlyDictionary<TokenType, IPrefixExpressionParsingStrategy> PrefixStrategies { get; set; } =
        new Dictionary<TokenType, IPrefixExpressionParsingStrategy>();

    protected IReadOnlyDictionary<TokenType, IInfixExpressionParsingStrategy> InfixStrategies { get; set; } =
